...
class DataInsightAgenticAgent implements Agent, HasTools
{
    ...
    public function tools(): iterable
    {
        ...
        if ($type === 'table') {
            return [
                new AddTableRowTool($this->data),
                new UpdateTableRowTool($this->data),
                new DeleteTableRowTool($this->data),
            ];
        }

        if ($type === 'doc') {
            return [
                new ReplaceDocContentTool($this->data),
                new AppendDocContentTool($this->data),
            ];
        }
