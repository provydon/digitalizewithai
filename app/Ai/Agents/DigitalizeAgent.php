...
class DigitalizeAgent implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): Stringable|string
    {
        return 'You extract handwritten or printed content from the attached image(s). '
            ...
            .'For type "doc": content must be the full extracted text as markdown—verbatim transcription, no additions or changes. IMPORTANT: the "content" string itself must be plain document text only. Do NOT wrap doc content in another JSON object, do NOT put ```json fences inside "content", and do NOT include literal keys like "type" or "content" inside a doc page. '
